  ...
  return (
    <div className="p-6 flex flex-col gap-6 max-w-3xl">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-title" style={{ color: 'var(--ct-text-1)' }}>Import API Spec</h1>
          <p className="text-body mt-1" style={{ color: 'var(--ct-text-2)' }}>
            Upload an OpenAPI 3.x spec. The spec is stored against the project and used to assist
            step authoring, suggest missing coverage, and validate your test endpoints.
          </p>
        </div>
